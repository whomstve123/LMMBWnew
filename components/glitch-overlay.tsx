...
const messages = [
  ...
  "EXTRACTING MUSIC FROM THE FACE YOU WEAR TODAY...",
  "RENDERING ECHOES OF YOUR UNKNOWABLE SELF...",
  "DECODING YOUR FREQUENCIES FROM BEHIND THE EYES...",
  "DISTILLING IDENTITY INTO WAVEFORM...",
  "REPLACING ALL YOUR PARTS UNTIL YOU'RE NOT THE SHIP YOU ONCE WERE...",
  "TUNING THE YOU INSIDE YOU...",
  "PERFORMING PERSONALITY SPECTROSCOPY...",
  "LOOPING THE GHOST IN YOUR MACHINE...",
  "RENDERING A MIRROR THAT SINGS BACK...",
  "DIVINING THE MELODY BURIED IN YOUR GEOMETRY...",
  "COMPOSING FROM YOUR CARBON BLUEPRINT...",
  "TRANSLATING PHOTONS TO FEELING...",
  "LOCATING SOUL THROUGH LATENCY...",
  "MERGING NEURAL NOISE WITH MUSICAL ORDER...",
  "SONIFYING THE SHAPE OF YOUR LONELINESS...",
  "SCORING YOUR SOFT APOCALYPSE...",
  "SAMPLING THE MYTH OF WHO YOU ARE...",
  "CASTING YOU IN A NEW SONIC MOLD...",
  "TAPPING INTO THE SONG YOU FORGOT YOU WERE SINGING...",
  "REVERBERATING THE ECHO OF WHAT YOU COULD'VE BEEN...",
  "SYNTHESIZING THE SELF FROM FACIAL TOPOGRAPHY...",
  "ALIGNING WAVEFORMS WITH MEMORY...",
  "CONSTRUCTING AUDIBLE ARTIFACTS OF YOUR BEING...",
  "FOSSILIZING A MOMENT OF YOU IN STEREO...",
  "GENERATING A TRACK NO ONE ELSE COULD WEAR...",
  "SCORING THE LIMINAL RESIDUE OF YOUR PRESENCE...",
  "SEQUENCING SOMETHING ONLY YOU COULD TRIGGER...",
  "COMPOSING FROM YOUR CONTRADICTIONS...",
  "EXTRACTING TRUTH FROM FACIAL FICTION...",
  "HARMONIZING...",
